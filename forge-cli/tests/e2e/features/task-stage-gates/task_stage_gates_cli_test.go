...
// forgeBinOnce ensures the binary is built only once across all tests.
var forgeBinOnce sync.Once

// buildForgeBinary builds forge from source and caches the binary path.
// Uses a persistent temp directory that survives individual test cleanup.
func buildForgeBinary(t *testing.T) string {
	t.Helper()
	var buildErr error
	forgeBinOnce.Do(func() {
...
// findProjectRoot walks up from cwd to find the go.mod root.
...
// runForgeIndex runs forge task index in the given project root using a binary built from source.
...
func TestTC_001_GeneratesSummaryAndGateForQualifyingPhases(t *testing.T) {
...
func TestTC_002_CorrectDependencyWiringForGateTasks(t *testing.T) {
...
func TestTC_003_SkipsSingleTaskPhases(t *testing.T) {
...
func TestTC_005_FiltersTestTasksFromBusinessCount(t *testing.T) {
...
func TestTC_006_IdempotentRerunPreservesExistingFiles(t *testing.T) {
...
func TestTC_007_GeneratesOnlyMissingGateWhenSummaryExists(t *testing.T) {
...
func TestTC_008_GeneratesOnlyMissingSummaryWhenGateExists(t *testing.T) {
...
func TestTC_009_SilentlySkipsMalformedTaskIDs(t *testing.T) {
...
func TestTC_010_PreservesPreexistingHandCraftedGateFiles(t *testing.T) {
...
func TestTC_011_GeneratedTasksInIndexJsonWithCorrectType(t *testing.T) {
...
func TestTC_012_PrintsSummaryLinePerQualifyingPhase(t *testing.T) {
...
func TestTC_013_PrintsNoQualificationMessage(t *testing.T) {
...
func TestTC_014_ExitsWithErrorOnTemplateRenderFailure(t *testing.T) {
...
func TestTC_015_QuickModeGeneratesStageGatesIdentically(t *testing.T) {
...
func TestTC_016_DoesNotBreakExistingIndexBehavior(t *testing.T) {
...
func TestTC_018_ConcurrentExecutionIdenticalOutput(t *testing.T) {
...
func TestTC_019_RejectsPathTraversalInTaskIDs(t *testing.T) {
...
func TestTC_020_GenerationCompletesWithinTimeBudget(t *testing.T) {
