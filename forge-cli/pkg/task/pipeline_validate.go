...
var PipelineRegistry = []PipelineNode{
	...
	{Type: TypeTestGenContracts, Key: "gen-contracts", ID: "T-test-gen-contracts",
		...
		ConfigGate: GateTest, GenerateCondition: CondHasProtocolSurfaceTask,
	...
	{Type: TypeEvalContract, Key: "eval-contract", ID: "T-eval-contract",
		...
		ConfigGate: GateTest, GenerateCondition: CondHasProtocolSurfaceTask, Mode: "breakdown", MainSession: true,
	...
	{Type: TypeTestGenScripts, Key: "gen-test-scripts-{surface-key}", ID: "T-test-gen-scripts-{surface-key}",
		...
		ConfigGate: GateTest, GenerateCondition: CondHasTestableTasks, Expansion: "per-surface-key",
		DependsOn: []DepRef{{Resolve: ResolveUpstream}}, StrategyKind: "generate"},
