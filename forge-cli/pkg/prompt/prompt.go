...
var typeToTemplate = map[string]string{
	task.TypeCodingFeature:        "data/feature.md",
	task.TypeCodingEnhancement:    "data/enhancement.md",
	task.TypeCodingCleanup:        "data/cleanup.md",
	task.TypeCodingRefactor:       "data/refactor.md",
	task.TypeDoc:                  "data/documentation.md",
	task.TypeDocEval:              "data/doc-evaluation.md",
	task.TypeDocSummary:           "data/doc-generation-summary.md",
	task.TypeDocConsolidate:       "data/doc-generation-consolidate.md",
	task.TypeDocDrift:             "data/doc-generation-drift.md",
	task.TypeTestGenCases:         "data/test-pipeline-gen-cases.md",
	task.TypeTestEvalCases:        "data/test-pipeline-eval-cases.md",
	task.TypeTestGenScripts:       "data/test-pipeline-gen-scripts.md",
	task.TypeTestRun:              "data/test-pipeline-run.md",
	task.TypeTestGenAndRun:        "data/test-pipeline-gen-and-run.md",
	task.TypeTestGraduate:         "data/test-pipeline-graduate.md",
	task.TypeTestVerifyRegression: "data/test-pipeline-verify-regression.md",
	task.TypeCodingFix:            "data/fix.md",
