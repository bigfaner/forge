// Package base provides shared error types and output formatting utilities
// for the forge CLI commands. Both the parent cmd package and sub-packages
// (e.g., task) import this to avoid circular dependencies.
package base
