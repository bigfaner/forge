...
func TestRunValidate(t *testing.T) {
	...
	index.SetTask("task2", task.Task{ID: "1.2", Title: "Task 2", Priority: "P1", Status: "pending", File: "1.2.md", Record: "1.2.md", Dependencies: []string{"1.1"}, Type: "coding.feature"})
	index.SetTask("task3", task.Task{ID: "1.3", Title: "Task 3", Priority: "P2", Status: "pending", File: "1.3.md", Record: "1.3.md", Dependencies: []string{"1.1", "1.2"}, Type: "coding.feature"})
	if err := task.SaveIndex(indexPath, index); err != nil {
		t.Fatal(err)
	}
...
func setupClaimTestProject(t *testing.T) string {
	...
	index.SetTasks(map[string]task.Task{
		"task1": {ID: "1.1", Title: "Task 1", Priority: "P0", Status: "pending", File: "1.1.md", Record: "records/1.1.md", Type: "coding.feature"},
	})
	if err := task.SaveIndex(indexPath, index); err != nil {
		t.Fatal(err)
	}
