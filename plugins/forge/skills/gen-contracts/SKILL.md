...
4. Load `rules/surface-<type>.md` for each detected surface type (these files reside in `gen-journeys/rules/`, not in gen-contracts)
...
|---------|--------------|------------------|
| API | `api-handbook.md` | `docs/features/<slug>/design/api-handbook.md` |
| CLI | `cli-handbook.md` | `docs/features/<slug>/design/cli-handbook.md` |
| TUI | `cli-handbook.md` | `docs/features/<slug>/design/cli-handbook.md` (shared with CLI) |
| Web | `page-map.md` | `docs/features/<slug>/design/page-map.md` |
| Mobile | `screen-map.md` | `docs/features/<slug>/design/screen-map.md` |
...
2. Find the tech-design file at `docs/features/<slug>/design/tech-design.md`
