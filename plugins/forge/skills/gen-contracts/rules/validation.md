...
| Language detection fails | Read `docs/conventions/testing/index.md` to discover Convention files, select by project context. Fallback: scan source/test files. If still unresolved, ask user |
| Interface detection fails | Ask user to configure `surfaces` in config.yaml |
