...
2. Read `plugins/forge/skills/learn/templates/decision-entry.md` for the row template.
...
1. Read `plugins/forge/skills/learn/templates/lesson-entry.md` for the file template.
...
1. Read `plugins/forge/skills/learn/templates/convention-entry.md` for the entry format.
