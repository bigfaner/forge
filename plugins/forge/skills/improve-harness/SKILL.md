...
4. **For project tests**: Run `just test [scope]` to ensure nothing broke — apply the **Scope Resolution** protocol in guide.md (`SCOPE` comes from the current task's claim output).
