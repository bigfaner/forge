...
| ------------------------- | ---------------------------------------------- | ------------------------------------------------------------------------- |
| Rubric (scoring criteria) | `eval/rubrics/harness.md` (resolve relative to the skills parent directory) | Defines the 4 dimensions and 12 criteria that findings are scored against |
...
4. **For project tests**: Run `just test <scope>` to ensure nothing broke
