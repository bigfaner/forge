...
- `docs/proposals/<slug>/proposal.md` — Source proposal with Success Criteria

## Acceptance Criteria

- [ ] `testing/test-cases.md` file created in `docs/features/<slug>/testing/`
...
1. Read `docs/proposals/<slug>/proposal.md`, extract Success Criteria section
