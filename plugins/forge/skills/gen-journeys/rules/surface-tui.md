...
**Test type**: Terminal Functional Test. Verifies terminal rendering output, keyboard input responses, and async Cmd timeout handling via subprocess with stdin pipe. Generated test code MUST use `@tui-functional` tags, NOT `@e2e`.
