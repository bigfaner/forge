---
name: eval
description: Generic document evaluation with scorer→gate→revise loop. Parameterized by rubric file. Uniform 1000-point scale across all rubrics. Detects UI platform for eval-ui. Skips reviser when iterations ≤ 1.
