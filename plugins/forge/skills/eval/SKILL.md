...
| `contract` | `testing/<journey>/_contracts/step-<N>-<action>.md` (generated by gen-contracts) |
...
| `journey` | `docs/features/<slug>/testing/` |
| `contract` | `docs/features/<slug>/testing/<journey>/_contracts/` |
