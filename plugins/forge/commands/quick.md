---
name: quick
description: Streamlined pipeline for features. Brainstorm -> tasks -> execute, no PRD or design.
...
2. ONE feature per invocation.
3. The /quick pipeline is for small, well-scoped features. If scope grows during brainstorm, recommend switching to full mode.
</EXTREMELY-IMPORTANT>
...
This produces:
- `docs/features/<slug>/tasks/*.md` — task files (coding + doc tasks + auto-generated test tasks)
