...
### Mixed Template (mixed projects: frontend + backend)

10 scoped recipes with `scope=""` parameter and bash case dispatch. 5 unscoped recipes (project-type, test-e2e, ci, e2e-setup, e2e-verify) have no scope parameter.
