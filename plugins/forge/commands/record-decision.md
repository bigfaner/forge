...
Follow the record-decision 4-round interaction flow defined in `plugins/forge/references/shared/decision-logging.md` (Section 3).
...
Refer to Sections 6 and 7 of `plugins/forge/references/shared/decision-logging.md` for the exact row format and manifest update protocol.
