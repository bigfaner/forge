...
// ==============================================================================
// Task record immutability tests — Journey: task-lifecycle
// Tests verify record submit, overwrite protection, task query output,
// verbose flags, and related-fixes display.
// ==============================================================================
...
func TestTC_022_SubmitRecordBlockedWhenRecordAlreadyExists(t *testing.T) {
	slug := "test-feature-tri"
	projectDir := createTempForgeProject(t, slug)
	indexJSON := minimalIndexJSON(slug, "task-1", "1", "Test Task")
	createFeatureIndex(t, projectDir, slug, indexJSON)
...
func TestTC_023_SubmitWithForceOverwritesExistingRecord(t *testing.T) {
	slug := "test-feature-tri"
	projectDir := createTempForgeProject(t, slug)
	indexJSON := minimalIndexJSON(slug, "task-1", "1", "Test Task")
	createFeatureIndex(t, projectDir, slug, indexJSON)
...
func TestTC_024_DefaultQueryShowsFourFieldsUnchanged(t *testing.T) {
	slug := "test-feature-tri"
	projectDir := createTempForgeProject(t, slug)
...
func TestTC_025_VerboseQueryDisplaysAllTaskFields(t *testing.T) {
	slug := "test-feature-tri"
	projectDir := createTempForgeProject(t, slug)
...
func TestTC_026_VerboseQueryShowsRelatedFixes(t *testing.T) {
	slug := "test-feature-tri"
	projectDir := createTempForgeProject(t, slug)
...
func TestTC_027_VerboseQueryOmitsRelatedFixesWhenNoneExist(t *testing.T) {
	slug := "test-feature-tri"
	projectDir := createTempForgeProject(t, slug)
...
func TestTC_028_StatusCommandBehaviorUnchanged(t *testing.T) {
	slug := "test-feature-tri"
	projectDir := createTempForgeProject(t, slug)
...
func TestTC_029_VerboseQueryWithShortFlag(t *testing.T) {
	slug := "test-feature-tri"
	projectDir := createTempForgeProject(t, slug)
...
func TestTC_030_VerboseQueryOmitsScopeWhenEmpty(t *testing.T) {
	slug := "test-feature-tri"
	projectDir := createTempForgeProject(t, slug)
...
// Traceability: TC-011 -> Proposed Solution 2 (default mode: "BREAKING (if true)")
func TestTC_031_VerboseQueryOmitsBreakingWhenFalse(t *testing.T) {
	slug := "test-feature-tri"
	projectDir := createTempForgeProject(t, slug)
...
// Traceability: TC-012 -> Proposed Solution 2 ("DEPENDENCIES (multi-line if multiple)")
func TestTC_032_VerboseQueryDisplaysMultiLineDependencies(t *testing.T) {
	slug := "test-feature-tri"
	projectDir := createTempForgeProject(t, slug)
