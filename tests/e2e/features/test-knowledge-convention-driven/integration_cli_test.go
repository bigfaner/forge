...
// ==============================================================================
// Integration and misc — CLI e2e tests for feature: test-knowledge-convention-driven
...
func TestTC_014_TaskIndexWorksWithoutProfileDependency(t *testing.T) {
...
// Note: init-justfile is a Claude Code skill, not a forge CLI command.
// This test verifies the observable justfile artifacts.

func TestTC_015_InitJustfileGeneratesRecipesWithoutProfile(t *testing.T) {
...
func TestTC_018_GenerationTimeWithinBudget(t *testing.T) {
	projectRoot, conventionsDir, _ := setupGoProjectFixture(t)

	// Create standard Convention file
	conventionContent := `---
domains: [testing, go]
---
## Framework
...
func TestTC_020_ConsolidateSpecsDetectsConventionDrift(t *testing.T) {
	projectRoot, conventionsDir, _ := setupGoProjectFixture(t)
...
// Note: run-e2e-tests is a Claude Code skill, not a forge CLI command.
// This test verifies the Convention-driven result format infrastructure.

func TestTC_027_RunE2eTestsParsesResultsWithConventionFormat(t *testing.T) {
	projectRoot, conventionsDir, _ := setupGoProjectFixture(t)

	// Step 1: Create Convention declaring json-stream result format
	conventionContent := `---
domains: [testing, go]
---
## Framework
...
`
	...
	// Verify Convention file exists with correct Result Format
...
func TestTC_029_E2eConventionThroughExecution(t *testing.T) {
	projectRoot, conventionsDir, _ := setupGoProjectFixture(t)
...
func TestTC_036_TestGuideToGenTestScriptsPipeline(t *testing.T) {
	projectRoot, conventionsDir, _ := setupGoProjectFixture(t)
