...
// ==============================================================================
// test-guide — CLI e2e tests for feature: test-knowledge-convention-driven
// Tests cover Convention file creation from existing patterns, multi-language
// support, and candidate presentation.
//
// Note: test-guide is a multi-turn conversational skill (FS-5), not a standalone
// forge CLI binary command. These tests verify observable file-system artifacts.
// ==============================================================================
...
func TestTC_003_TestGuideConventionFileCreatedFromExistingTests(t *testing.T) {
...
`
	...
	// that test-guide would produce from pattern analysis
...
func TestTC_004_TestGuideConventionFilesForMultipleLanguages(t *testing.T) {
	projectRoot := t.TempDir()
...
func TestTC_030_TestGuidePresentsCandidatesWhenNoTestFiles(t *testing.T) {
	projectRoot := t.TempDir()
