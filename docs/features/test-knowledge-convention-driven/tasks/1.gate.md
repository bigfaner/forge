...
- This phase's task records: `docs/features/test-knowledge-convention-driven/tasks/records/1.*.md`
- This phase's summary: `docs/features/test-knowledge-convention-driven/tasks/records/1-summary.md`
