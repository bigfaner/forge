...
- Design: `docs/features/test-knowledge-convention-driven/design/tech-design.md`
- This phase's task records: `docs/features/test-knowledge-convention-driven/tasks/records/3.*.md`
- This phase's summary: `docs/features/test-knowledge-convention-driven/tasks/records/3-summary.md`
