...
Error Trace:	Z:/project/ai/forge/tests/e2e/test_scripts_per_type_cli_test.go:594
...
FAIL
exit status 1
FAIL	e2e-tests	4.746s
error: recipe `test-e2e` failed with exit code 1
```

## Reference Files

- Source: quality_gate_fix_task_loop_breaker_cli_test.go, project/ai/forge/tests/e2e/quality_gate_fix_task_loop_breaker_cli_test.go, quick_test_slim_cli_test.go, project/ai/forge/tests/e2e/quick_test_slim_cli_test.go, test_scripts_per_type_cli_test.go, project/ai/forge/tests/e2e/test_scripts_per_type_cli_test.go
