...
Test:       	TestTC_011_PerTypeGenScriptsMdHasCorrectTaskIDs
Messages:   	task gen-test-scripts-go-test-ui should exist
--- FAIL: TestTC_011_PerTypeGenScriptsMdHasCorrectTaskIDs (0.06s)
=== RUN   TestTC_012_TaskIndexSharedInfrastructureNotDuplicated
--- PASS: TestTC_012_TaskIndexSharedInfrastructureNotDuplicated (0.06s)
FAIL
exit status 1
FAIL	e2e-tests	5.881s
error: recipe `test-e2e` failed with exit code 1
```

## Reference Files

- Source: quick_test_slim_cli_test.go, project/ai/forge/tests/e2e/quick_test_slim_cli_test.go, test_scripts_per_type_cli_test.go, project/ai/forge/tests/e2e/test_scripts_per_type_cli_test.go
