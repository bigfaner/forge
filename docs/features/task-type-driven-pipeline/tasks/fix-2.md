...
...
FAIL
FAIL	forge-cli/pkg/project	0.561s
...
ok  	forge-cli/pkg/testrunner	1.924s
...
- Source: add_cmd_test.go, claim_test.go, feature_test.go, project/ai/coding-harness/forge-2/forge-cli/internal/cmd/feature_test.go, root_test.go
