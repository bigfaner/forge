...
| Document | Path |
|----------|------|
| Proposal | ../../proposals/skill-slimming/proposal.md |
...
| 7 | Slim task pipeline domain (breakdown-tasks + quick-tasks + submit-task) | pending | tasks/7-slim-task-pipeline-domain.md |
| 8 | Slim meta/analysis domain (brainstorm + learn + forensic + improve-harness) | pending | tasks/8-slim-meta-analysis-domain.md |
| 9 | Slim utility domain (clean-code + run-e2e-tests) | pending | tasks/9-slim-utility-domain.md |
