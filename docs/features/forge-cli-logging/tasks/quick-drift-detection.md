...
Detect spec drift between existing project specs and current code for the forge-cli-logging feature.
...
## Acceptance Criteria
- [ ] Drift detection completed; any found drifts are auto-fixed or reported
