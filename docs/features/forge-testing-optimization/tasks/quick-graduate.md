...
Call `/graduate-tests` skill to migrate feature test scripts from `tests/e2e/features/forge-testing-optimization/` to the
...
- `tests/e2e/features/forge-testing-optimization/results/latest.md` — Must show status = PASS before graduating
- `tests/e2e/features/forge-testing-optimization/` — Source scripts to migrate
- `tests/e2e/` — Destination regression suite

## Acceptance Criteria

- [ ] `tests/e2e/features/forge-testing-optimization/results/latest.md` shows status = PASS
- [ ] `tests/e2e/.graduated/forge-testing-optimization` marker exists
...
Read `tests/e2e/features/forge-testing-optimization/results/latest.md`. Check status field.
...
- Create graduation marker `tests/e2e/.graduated/forge-testing-optimization`
