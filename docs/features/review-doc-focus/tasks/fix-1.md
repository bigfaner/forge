...
ok  	forge-cli/pkg/research	(cached)
ok  	forge-cli/pkg/task	(cached)
ok  	forge-cli/pkg/template	(cached)
ok  	forge-cli/pkg/testrunner	5.904s
...
- Source: runtime/panic.go, runtime/malloc.go, runtime/mfixalloc.go, runtime/mheap.go, runtime/mcentral.go, runtime/mcache.go, runtime/proc.go, cmd/compile/internal/ssa/regalloc.go, cmd/compile/internal/ssa/compile.go, cmd/compile/internal/ssagen/ssa.go
