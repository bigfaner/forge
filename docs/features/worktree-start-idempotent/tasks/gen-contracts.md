...
Generate test Contract specifications for the worktree-start-idempotent feature.
Mode: quick
...
2. **Read Journeys**: Enumerate Journey directories under `docs/features/worktree-start-idempotent/testing/` and read each `journey.md`
...
6. **Write Output**: Write Contract files to `docs/features/worktree-start-idempotent/testing/<journey>/contracts/` and Fact Table to `.forge/fact-table.json`
