...
test_scripts_per_type_cli_test.go:609:
Error Trace:	Z:/project/ai/coding-harness/forge-4/tests/e2e/test_scripts_per_type_cli_test.go:609
Error:      	Should be true
Test:       	TestTC_012_TaskIndexSharedInfrastructureNotDuplicated
--- FAIL: TestTC_012_TaskIndexSharedInfrastructureNotDuplicated (0.19s)
FAIL
exit status 1
FAIL	e2e-tests	25.630s
error: recipe `test-e2e` failed with exit code 1
```

## Reference Files

- Source: quick_test_slim_cli_test.go, project/ai/coding-harness/forge-4/tests/e2e/quick_test_slim_cli_test.go, test_scripts_per_type_cli_test.go, project/ai/coding-harness/forge-4/tests/e2e/test_scripts_per_type_cli_test.go
