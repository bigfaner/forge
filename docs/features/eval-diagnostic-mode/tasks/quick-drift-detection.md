...
Detect spec drift between existing project specs and current code for the eval-diagnostic-mode feature.
...
## Acceptance Criteria
- [ ] Drift check completed (skipped if no code changes detected)
