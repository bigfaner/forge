...
```
...
=== RUN   TestTC_010_TaskIndexPerTypeIdempotent
--- PASS: TestTC_010_TaskIndexPerTypeIdempotent (0.11s)
=== RUN   TestTC_011_PerTypeGenScriptsMdHasCorrectTaskIDs
--- PASS: TestTC_011_PerTypeGenScriptsMdHasCorrectTaskIDs (0.07s)
...
FAIL
exit status 1
FAIL	e2e-tests	25.902s
error: recipe `test-e2e` failed with exit code 1
```

## Reference Files

- Source: task_record_immutability_cli_test.go, project/ai/coding-harness/forge-2/tests/e2e/task_record_immutability_cli_test.go
