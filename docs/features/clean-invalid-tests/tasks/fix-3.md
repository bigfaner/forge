---
id: "fix-3"
title: "Fix: test-generation e2e failures"
priority: "P0"
...
# Fix: test-generation e2e failures

## Root Cause

CLI tests for task index and test generation pipeline failing

## Reference Files

- Source: tests/test-generation/
- Test script: just test test-generation
- Test results: 16 failures: quick-mode and per-type tests
...
1. Parse `tests/test-generation/` to extract the first file path (comma-separated).
