...
- Design: `docs/features/unify-enum-constants/design/tech-design.md`
- This phase's task records: `docs/features/unify-enum-constants/tasks/records/4.*.md`
- This phase's summary: `docs/features/unify-enum-constants/tasks/records/4-summary.md`
