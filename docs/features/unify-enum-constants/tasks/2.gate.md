...
- This phase's task records: `docs/features/unify-enum-constants/tasks/records/2.*.md`
- This phase's summary: `docs/features/unify-enum-constants/tasks/records/2-summary.md`
