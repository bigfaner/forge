...
Generate test Contract specifications for the unify-enum-constants feature.
Mode: breakdown
...
2. **Read Journeys**: Enumerate Journey directories under `docs/features/unify-enum-constants/testing/` and read each `journey.md`
...
6. **Write Output**: Write Contract files to `docs/features/unify-enum-constants/testing/<journey>/contracts/` and Fact Table to `.forge/fact-table.json`
