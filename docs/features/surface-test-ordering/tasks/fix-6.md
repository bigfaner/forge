---
id: "fix-6"
title: "Fix: remaining test suites config fixtures"
priority: "P0"
...
# Fix: remaining test suites config fixtures

## Root Cause

Fix config fixtures in surface-key-migration, quality-gate, task-lifecycle, task-type-system, automated-test-orchestration

## Reference Files

- Source: tests/surface-key-migration/*.go,tests/quality-gate/*.go,tests/task-lifecycle/*.go,tests/task-type-system/*.go,tests/automated-test-orchestration/*.go
- Test script: cd tests && go test -tags e2e ./surface-key-migration/... ./quality-gate/... ./task-lifecycle/... ./task-type-system/... ./automated-test-orchestration/... -count=1
- Test results: Various config fixture issues across 5 suites
...
1. Parse `tests/surface-key-migration/*.go,tests/quality-gate/*.go,tests/task-lifecycle/*.go,tests/task-type-system/*.go,tests/automated-test-orchestration/*.go` to extract the first file path (comma-separated).
