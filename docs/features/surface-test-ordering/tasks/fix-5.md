---
id: "fix-5"
title: "Fix: surface-aware-recipe-generation config fixtures"
priority: "P0"
...
# Fix: surface-aware-recipe-generation config fixtures

## Root Cause

Add surfaces field to all config fixtures in surface-aware-recipe-generation tests

## Reference Files

- Source: tests/surface-aware-recipe-generation/*.go
- Test script: cd tests && go test -tags e2e ./surface-aware-recipe-generation/... -count=1
- Test results: 5 tests fail - missing surfaces in config
...
1. Parse `tests/surface-aware-recipe-generation/*.go` to extract the first file path (comma-separated).
