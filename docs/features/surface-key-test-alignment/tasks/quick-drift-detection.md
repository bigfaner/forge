...
Detect spec drift between existing project specs and current code for the surface-key-test-alignment feature.
...
## Acceptance Criteria
- [ ] Drift detection completed for specs overlapping with changed files
- [ ] Drifted specs auto-fixed and committed (if any drift found)
