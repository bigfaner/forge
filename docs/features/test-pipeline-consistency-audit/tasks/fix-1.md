...
FAIL
FAIL	forge-tests/test-suite-health	4.540s
...
- Source: smoke_test.go, step1_run_tests_frontmatter_test.go, Users/fanhuifeng/Projects/ai/coding-harness/forge/.forge/worktrees/test-pipeline-consistency-audit/tests/automated-test-orchestration/step1_run_tests_frontmatter_test.go, step2_load_strategy_rule_test.go, step3_execute_dev_test.go, step4_execute_probe_test.go, step5_execute_test_test.go, step6_teardown_test.go, step7_alternative_surfaces_test.go, cli_list_reverse_chronological_test.go
...
1. Parse `smoke_test.go, step1_run_tests_frontmatter_test.go, Users/fanhuifeng/Projects/ai/coding-harness/forge/.forge/worktrees/test-pipeline-consistency-audit/tests/automated-test-orchestration/step1_run_tests_frontmatter_test.go, step2_load_strategy_rule_test.go, step3_execute_dev_test.go, step4_execute_probe_test.go, step5_execute_test_test.go, step6_teardown_test.go, step7_alternative_surfaces_test.go, cli_list_reverse_chronological_test.go` to extract the first file path (comma-separated).
