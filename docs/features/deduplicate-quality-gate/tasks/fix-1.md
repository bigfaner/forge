...
--- FAIL: TestGet_FixTask (0.00s)
template_test.go:47: fix-task template missing "just test [scope]"
FAIL
FAIL	forge-cli/pkg/template	0.241s
...
- Source: extract_design_md_test.go, prompt_test.go, template_test.go
