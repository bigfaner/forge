...
```
...
types_test.go:688: SystemTypes has 12 entries, want 13
--- FAIL: TestSystemTypes/all_system_types_are_present (0.00s)
types_test.go:708: SystemTypes missing "doc.fix"
FAIL
FAIL	forge-cli/pkg/task	1.576s
ok  	forge-cli/pkg/testrunner	(cached)
ok  	forge-cli/pkg/types	(cached)
ok  	forge-cli/pkg/version	(cached)
FAIL
error: recipe `unit-test` failed with exit code 1
```
