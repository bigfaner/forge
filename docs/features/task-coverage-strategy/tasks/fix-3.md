...
FAIL
exit status 1
FAIL	e2e-tests	2.273s
error: recipe `test-e2e` failed with exit code 1
```

## Reference Files

- Source: e2e_test_quality_cleanup_cli_test.go, Users/fanhuifeng/Projects/ai/coding-harness/forge/.forge/worktrees/task-coverage-strategy/tests/e2e/e2e_test_quality_cleanup_cli_test.go, helpers.go, gen_test_scripts_cli_test.go, test_guide_cli_test.go, quality_gate_fix_task_loop_breaker_cli_test.go, Users/fanhuifeng/Projects/ai/coding-harness/forge/.forge/worktrees/task-coverage-strategy/tests/e2e/quality_gate_fix_task_loop_breaker_cli_test.go, quick_test_slim_cli_test.go, Users/fanhuifeng/Projects/ai/coding-harness/forge/.forge/worktrees/task-coverage-strategy/tests/e2e/quick_test_slim_cli_test.go, task_lifecycle_hardening_cli_test.go
