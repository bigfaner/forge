...
- This phase's task records: `docs/features/forge-architecture-simplification/tasks/records/2.*.md`
- This phase's summary: `docs/features/forge-architecture-simplification/tasks/records/2-summary.md`
