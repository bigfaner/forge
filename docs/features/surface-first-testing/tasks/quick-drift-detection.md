...
Detect spec drift between existing project specs and current code for the surface-first-testing feature.
...
## Acceptance Criteria
- [ ] Spec drift detected and auto-fixed for specs whose domains overlap with changed files
