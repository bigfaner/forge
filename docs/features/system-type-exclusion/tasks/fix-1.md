...
Error Trace:	/Users/fanhuifeng/Projects/ai/coding-harness/forge/.forge/worktrees/system-type-exclusion/tests/e2e/test_scripts_per_type_cli_test.go:602
Error:      	Should be true
Test:       	TestTC_012_TaskIndexSharedInfrastructureNotDuplicated
--- FAIL: TestTC_012_TaskIndexSharedInfrastructureNotDuplicated (0.02s)
FAIL
exit status 1
FAIL	e2e-tests	3.087s
error: recipe `test-e2e` failed with exit code 1
```

## Reference Files

- Source: e2e_test_quality_cleanup_cli_test.go, Users/fanhuifeng/Projects/ai/coding-harness/forge/.forge/worktrees/system-type-exclusion/tests/e2e/e2e_test_quality_cleanup_cli_test.go, helpers.go, gen_test_scripts_cli_test.go, test_guide_cli_test.go, quality_gate_fix_task_loop_breaker_cli_test.go, Users/fanhuifeng/Projects/ai/coding-harness/forge/.forge/worktrees/system-type-exclusion/tests/e2e/quality_gate_fix_task_loop_breaker_cli_test.go, quick_test_slim_cli_test.go, Users/fanhuifeng/Projects/ai/coding-harness/forge/.forge/worktrees/system-type-exclusion/tests/e2e/quick_test_slim_cli_test.go, task_lifecycle_hardening_cli_test.go
