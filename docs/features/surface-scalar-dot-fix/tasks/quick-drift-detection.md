...
Detect spec drift between existing project specs and current code for the surface-scalar-dot-fix feature.
...
## Acceptance Criteria
- [ ] Only specs with domains overlapping changed files were checked
- [ ] Drift report produced (or confirmed no drift)
