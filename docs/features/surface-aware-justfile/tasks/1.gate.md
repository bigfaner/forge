...
- Design: `docs/features/surface-aware-justfile/design/tech-design.md`
- This phase's task records: `docs/features/surface-aware-justfile/tasks/records/1.*.md`
- This phase's summary: `docs/features/surface-aware-justfile/tasks/records/1-summary.md`
