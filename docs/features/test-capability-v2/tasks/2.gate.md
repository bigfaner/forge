...
- This phase's task records: `docs/features/test-capability-v2/tasks/records/2.*.md`
- This phase's summary: `docs/features/test-capability-v2/tasks/records/2-summary.md`
