...
root_test.go:205: Path = "Z:\\project\\ai\\forge", want "C:\\Users\\panda\\AppData\\Local\\Temp\\TestFindRootInfoFromfinds_root_from_subdirectory4016662861\\001"
FAIL
FAIL	task-cli/pkg/project	0.576s
ok  	task-cli/pkg/task	(cached)
ok  	task-cli/pkg/template	(cached)
ok  	task-cli/pkg/testrunner	1.392s
