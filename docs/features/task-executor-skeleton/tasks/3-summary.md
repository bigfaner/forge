...
Read each record file from `docs/features/task-executor-skeleton/tasks/records/` whose filename starts with `3.` and does NOT contain `.summary`.
...
- All phase task records: `docs/features/task-executor-skeleton/tasks/records/3.*.md`
