...
Generate a structured summary of all completed tasks in Phase 3 (Feature Migration). This summary is read by subsequent phase tasks to maintain cross-phase consistency.

## Instructions

### Step 1: Read all phase task records

Read each record file from `docs/features/forge-cli-v3/tasks/records/` whose filename starts with `3.` and does NOT contain `.summary`. Exclude the phase summary's own prior record if one exists.
...
- All phase task records: `docs/features/forge-cli-v3/tasks/records/3.*.md`
