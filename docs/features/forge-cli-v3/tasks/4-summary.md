...
Generate a structured summary of all completed tasks in Phase 4 (Reference Updates). This summary is read by test tasks to verify complete migration.

## Instructions

### Step 1: Read all phase task records

Read each record file from `docs/features/forge-cli-v3/tasks/records/` whose filename starts with `4.` and does NOT contain `.summary`. Exclude the phase summary's own prior record if one exists.
...
- All phase task records: `docs/features/forge-cli-v3/tasks/records/4.*.md`
