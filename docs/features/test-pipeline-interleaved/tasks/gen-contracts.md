...
Generate test Contract specifications for the test-pipeline-interleaved feature.
Mode: quick
...
2. **Read Journeys**: Enumerate Journey directories under `docs/features/test-pipeline-interleaved/testing/` and read each `journey.md`
...
6. **Write Output**: Write Contract files to `docs/features/test-pipeline-interleaved/testing/<journey>/contracts/` and Fact Table to `.forge/fact-table.json`
