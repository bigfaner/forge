...
--- PASS: TestTC_010_TaskIndexPerTypeIdempotent (0.09s)
=== RUN   TestTC_011_PerTypeGenScriptsMdHasCorrectTaskIDs
--- PASS: TestTC_011_PerTypeGenScriptsMdHasCorrectTaskIDs (0.06s)
...
FAIL
exit status 1
FAIL	e2e-tests	4.623s
error: recipe `test-e2e` failed with exit code 1
```

## Reference Files

- Source: quick_test_slim_cli_test.go, project/ai/forge/tests/e2e/quick_test_slim_cli_test.go
