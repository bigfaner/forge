...
Error Trace:	Z:/project/ai/coding-harness/forge-3/tests/e2e/test_scripts_per_type_cli_test.go:609
Error:      	Should be true
Test:       	TestTC_012_TaskIndexSharedInfrastructureNotDuplicated
--- FAIL: TestTC_012_TaskIndexSharedInfrastructureNotDuplicated (0.09s)
FAIL
exit status 1
FAIL	e2e-tests	11.361s
error: recipe `test-e2e` failed with exit code 1
```

## Reference Files

- Source: quick_test_slim_cli_test.go, project/ai/coding-harness/forge-3/tests/e2e/quick_test_slim_cli_test.go, test_scripts_per_type_cli_test.go, project/ai/coding-harness/forge-3/tests/e2e/test_scripts_per_type_cli_test.go
