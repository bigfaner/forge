...
- Runs spec files from `tests/e2e/justfile-standard-vocabulary/`
- Writes `testing/results/latest.md` (PASS or FAIL)
- Writes `testing/results/raw-output.txt` on failure

## Reference Files

- `tests/e2e/justfile-standard-vocabulary/` — Test scripts generated by T-test-2
...
3. Run: `just test-e2e --feature justfile-standard-vocabulary`
