...
Read each record file from `docs/features/typed-verification-strategies/tasks/records/` whose filename starts with `1.` and does NOT contain `.summary`. Exclude the phase summary's own prior record if one exists.
...
- All phase task records: `docs/features/typed-verification-strategies/tasks/records/1.*.md`
