...
```
...
root_test.go:205: Path = "/Users/fanhuifeng/Projects/ai/coding-harness/forge", want "/var/folders/kc/yrzm7gsd2sz6kh60ftdxhcww0000gn/T/TestFindRootInfoFromfinds_root_from_subdirectory2769426512/001"
FAIL
FAIL	task-cli/pkg/project	1.418s
ok  	task-cli/pkg/prompt	(cached)
ok  	task-cli/pkg/task	(cached)
ok  	task-cli/pkg/template	(cached)
ok  	task-cli/pkg/testrunner	1.501s
...
- Source: add_cmd_test.go, claim_test.go, feature_test.go, root_test.go
