...
Concise error:
```
--- FAIL: TestTC_009_BuildIndexGeneratesEvalDocForDocumentationOnly (0.02s)
--- FAIL: TestPerType_TC_010_TaskIndexPerTypeIdempotent (0.03s)
```

## Reference Files

- Source: smoke_test.go, step2_load_strategy_rule_test.go, step3_execute_dev_test.go, step4_execute_probe_test.go, step5_execute_test_test.go, step6_teardown_test.go, step7_alternative_surfaces_test.go, step1_configure_surfaces_test.go, step2_init_justfile_test.go, step2_task_struct_test.go
