...
## Reference Files
- `forge-cli/pkg/task/build.go:331-416`: Steps 7/7.5/7.6 — rewrite to call GenerateTestTasks with businessTasks + existingTasks (source: proposal.md#Functions-Relationship)
- `forge-cli/pkg/task/autogen.go:843-919`: `ResolveFirstTestDep` — delete, logic covered by ResolveHighestGateOrLastBiz + ResolveIfGenerated (source: proposal.md#Functions-Relationship)
- `forge-cli/pkg/task/build.go:588-610`: `resolveTestDepsAndInjectReviewDoc` — delete, covered by ResolveIfGenerated (source: proposal.md#Functions-Relationship)
- `forge-cli/pkg/task/build.go:502`: `GenerateTestTasks` dispatcher — update to call registry-driven version (source: proposal.md#Breaking-Change)
- `forge-cli/pkg/task/build.go:419`: `ResolveDriftFallbackDep` call at step 7.6 — delete, covered by ResolveLastRunTestOrBusiness (source: proposal.md#Functions-Relationship)
