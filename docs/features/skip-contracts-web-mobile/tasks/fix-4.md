...
--- FAIL: TestTSG_001_GeneratesSummaryAndGateForQualifyingPhases (0.01s)
--- FAIL: TestTSG_002_CorrectDependencyWiringForGateTasks (0.01s)
--- FAIL: TestTSG_003_SkipsSingleTaskPhases (0.01s)
--- FAIL: TestTSG_004_ExcludesTestOnlyPhases (0.01s)
--- FAIL: TestTSG_005_FiltersTestTasksFromBusinessCount (0.01s)
--- FAIL: TestTSG_006_IdempotentRerunPreservesExistingFiles (0.02s)
--- FAIL: TestTSG_007_GeneratesOnlyMissingGateWhenSummaryExists (0.01s)
...
--- FAIL: TestTSG_011_GeneratedTasksInIndexJsonWithCorrectType (0.02s)
--- FAIL: TestTSG_012_PrintsSummaryLinePerQualifyingPhase (0.02s)
--- FAIL: TestTSG_013_PrintsNoQualificationMessage (0.02s)
...
--- FAIL: TestTSG_020_GenerationCompletesWithinTimeBudget (0.05s)
...
- Source: Users/fanhuifeng/Projects/ai/coding-harness/forge/.forge/worktrees/skip-contracts-web-mobile/tests/justfile-integration/forge_detection_test.go
