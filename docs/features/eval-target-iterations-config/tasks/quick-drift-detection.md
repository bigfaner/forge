...
Detect spec drift between existing project specs and current code for the eval-target-iterations-config feature.
...
## Acceptance Criteria
- [ ] Spec drift detected and fixed (or confirmed no drift) for files changed by this feature
