...
- 每个 SKILL.md 行数不超过 500 行（放宽自 350 行，因复杂 skill 的流程骨架天然较长；5 个已知超标文件待拆分：init-justfile 504 行, write-prd 453 行, tech-design 445 行, gen-journeys 392 行, gen-test-scripts 370 行）
