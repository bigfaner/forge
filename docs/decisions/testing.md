...
| 2026-05-20 | task-coverage-strategy | Per-task-type coverage tiers via config-driven prompt injection | CI gates are post-hoc and don't prevent agent test loops; prompt injection gives agents a clear stop signal | task-coverage-strategy/proposal.md §Proposed Solution |
